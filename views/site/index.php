            ...
            <div class="items-center justify-center flex flex-col">
              ...
              <div id="projectInfo" class="flex container items-end justify-between mt-10 mx-auto">
                <span class="text-gray-700 text-2xl lg:text-3xl">
                  ...
                  Меня зовут <b>Александр</b> <br> Это мой первый проект, на стеке HTML, CSS, JS, PHP, SQL
                </span>
              </div>
              ...
              <ul class="flex flex-col gap-12 px-8 relative">
                ...
                <li id="listItem3">
                  ...
                  <div>
                    ...
                    <p class="font-semibold text-gray-400 text-sm">Поделись своим бутербродом с другими</p>
                  </div>
                </li>
                ...
                <li id="listItem4">
                  ...
                  <div>
                    ...
                    <p class="font-semibold text-gray-400 text-sm">Рассчитать стоимость доставки бутербродов на дом</p>
                  </div>
                </li>
